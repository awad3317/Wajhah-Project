...
class EstablishmentRepository implements RepositoriesInterface
{
    ...
    {
        return Establishment::with(['region.parent','images','features','rules','pricePackages.icon','specifications','unavailabilityDays'])->withAvg('reviews', 'rating')->where('is_verified','=',true)->findOrFail($id);
    }
